...
$$(addsuffix .tab.cpp,$(1)) :  $${COMMDIR}/params2c.xsl $$(addsuffix .xml,$(1)) common/preproc.xsl
	xsltproc common/preproc.xsl $$(addsuffix .xml,$(1)) | xsltproc common/preproc.xsl - | xsltproc --output $$@  $$< -

$$(addsuffix .tab.hh,$(1)) :  $${COMMDIR}/params2h.xsl $$(addsuffix .xml,$(1)) common/preproc.xsl
	xsltproc common/preproc.xsl $$(addsuffix .xml,$(1)) | xsltproc common/preproc.xsl - | xsltproc --output $$@  $$< -
...
test_hatching01:
	./$(addprefix ${CMD_PREFIX},hatching01) -o hatching01a.png
